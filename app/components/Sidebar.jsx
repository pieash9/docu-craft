...
const Sidebar = ({ docs }) => {
  ...
  const [nonRootsNodesGrouped, setNonRootsNodesGrouped] = useState({});
  ...
  useEffect(() => {
    ...
    setRootNodes([...roots]);
    setNonRootsNodesGrouped({ ...nonRoots });
  }, [pathname]);
          ...
          <ul role="list" className="border-l border-transparent">
            {rootNodes.map((rootNode) => (
              <li key={rootNode.id} className="relative">
                ...
                {nonRootsNodesGrouped[rootNode.id] && (
                  <ul role="list" className="border-l border-transparent">
                    {nonRootsNodesGrouped[rootNode.id].map((subRoot) => (
                      <li key={subRoot.id}>
                        <Link
